...
MetroTimer::MetroTimer(unsigned long interval_millis) {
...
MetroTimer::MetroTimer(unsigned long interval_millis, uint8_t autoreset) {
...
void MetroTimer::interval(unsigned long interval_millis) {
